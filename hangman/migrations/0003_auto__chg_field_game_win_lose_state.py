...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.win_lose_state'
        db.alter_column(u'hangman_game', 'win_lose_state', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Game.win_lose_state'
        db.alter_column(u'hangman_game', 'win_lose_state', self.gf('django.db.models.fields.BooleanField')(default=None))
