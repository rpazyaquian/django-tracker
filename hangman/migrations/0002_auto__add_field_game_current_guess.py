...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.current_guess'
        db.add_column(u'hangman_game', 'current_guess',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.current_guess'
        db.delete_column(u'hangman_game', 'current_guess')
    ...
    models = {
        ...
        u'hangman.game': {
            ...
            'win_lose_state': ('django.db.models.fields.BooleanField', [], {}),
